...
const styles = {
  ...
  buttonBlue: `text-yellow bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`,
  buttonGrey: `text-gray-500 bg-yellow hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-yellow dark:hover:bg-gray-600 dark:focus:ring-gray-600`,
  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-xl h-full md:h-auto left-1/2 -translate-x-1/2">
        <div className="relative bg-yellow rounded-lg shadow">
          <h3 className={styles.heading3}>Time-Based One Time Password Authentication (TOTP)</h3>
          {/* Modal body */}
